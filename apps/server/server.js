...
// Persist authentication sessions in the same store that bootstrap.js syncs to PostgreSQL.
// The previous sessions lived only in a process-local Map, so a restart/deploy invalidated them.
